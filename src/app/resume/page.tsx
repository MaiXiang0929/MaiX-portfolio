...
const skillGroups = [
  { title: "Programming", items: ["C++", "C#", "Python", "C"] },
  { title: "Engine", items: ["Unreal Engine 5", "Unity"] },
  {
    title: "Rendering / Shader",
    items: ["HLSL / GLSL", "OpenGL 3.3", "Unity Shader", "NPR / 卡通渲染", "Post Process", "RenderDoc"],
  },
  { title: "DCC", items: ["Blender", "Houdini", "3ds Max", "Substance Designer"] },
  { title: "Workflow", items: ["Git", "CMake", "PS / AI / PR / AE"] },
];
...
const experiences = [
  {
    ...
    description: "成功入选技术美术方向培养项目，参与线上课程学习，持续补充实时渲染、Shader 与技术美术相关知识体系。",
  },
  {
    title: "“萌芽”社联 GameJam",
    period: "2026.02",
...
export default function ResumePage() {
  return (
    <main className="min-h-screen bg-[#08090c] text-[#d7dce5] selection:bg-[#00ffcc] selection:text-black">
      {/* 顶部导航保持与作品集首页一致，并提供 PDF 下载入口。 */}
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#08090c]/90 px-6 py-4 backdrop-blur-md print:hidden">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          ...
          <div className="flex items-center gap-5 font-mono text-xs sm:text-sm">
            ...
            <a href="/resume.pdf" target="_blank" rel="noreferrer" className="rounded-full border border-[#00ffcc]/50 px-4 py-2 text-[#00ffcc] transition-colors hover:bg-[#00ffcc] hover:text-black">
              PDF 简历
            </a>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 lg:py-20">
        ...
        <header className="relative overflow-hidden border border-white/10 bg-[#0d1015] p-7 sm:p-10 lg:p-14">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <p className="mt-4 text-lg text-white/70 sm:text-xl">实时渲染 · Shader · NPR · Technical Art Tools</p>
              <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 font-mono text-sm text-white/60">
        ...
        <div className="mt-16 grid gap-14 lg:grid-cols-[280px_1fr]">
          <aside className="space-y-12">
            <section>
              ...
              <p className="mt-3 leading-7 text-white/60">实时渲染 / Shader / NPR / Technical Art Tools</p>
            </section>

            <section>
              <p className="font-mono text-xs tracking-widest text-[#00ffcc]">02 / STACK</p>
              <h2 className="mt-4 text-2xl font-bold text-white">技术栈</h2>
            ...
            <section>
              ...
              <div className="mt-6 space-y-7 text-sm leading-6 text-white/60">
                <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group block border-l-2 border-[#00ffcc] bg-[#00ffcc]/5 p-5 transition-colors hover:bg-[#00ffcc]/10"
            >
          ...
          <div className="space-y-16">
            <section>
              ...
              <div className="space-y-5">
                {projects.map((project, projectIndex) => (
                  <article key={project.title} className="group border border-white/10 bg-[#0d1015] p-6 transition-colors hover:border-[#00ffcc]/40 sm:p-8">
            ...
            <section className="border border-white/10 bg-gradient-to-br from-[#102026] to-[#0d1015] p-7 sm:p-9">
        ...
        <footer className="mt-20 flex flex-col gap-2 border-t border-white/10 py-8 font-mono text-xs text-white/35 sm:flex-row sm:justify-between">
